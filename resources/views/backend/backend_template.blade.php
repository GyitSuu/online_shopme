...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('admin.township.index')}}">Township</a>
            <a class="collapse-item" href="{{route('admin.size.index')}}">Size</a>
          </div>
        </div>
      </li> --}}
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="{{route('admin.category.index')}}"><i class="fas fa-fw fa-chart-area"></i>
          <span>Category</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{route('admin.township.index')}}"><i class="fas fa-fw fa-chart-area"></i>
          <span>Township</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{route('admin.delivery_fee.index')}}"><i class="fas fa-fw fa-chart-area"></i>
          <span>Delivery Fee</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{route('admin.size.index')}}"><i class="fas fa-fw fa-chart-area"></i>
          <span>Size</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{route('admin.color.index')}}"><i class="fas fa-fw fa-chart-area"></i>
          <span>Color</span></a>
      </li>
